...
import com.pushups.BiaozhunCounter.MySensorListener;
...
public class KuanJuWaiXiangCounter extends Activity {
	...
	class MySensorListener implements SensorEventListener
	{
		...
		public void onSensorChanged(SensorEvent e) {
			...
			if(count==5)
			{
				...
				showDialog(KuanJuWaiXiangCounter.this, "恭喜您，完成宽距外向俯卧撑5个的锻炼目标！");
			}
